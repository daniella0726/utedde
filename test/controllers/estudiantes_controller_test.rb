...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { p1: @estudiante.p1, p2: @estudiante.p2, p3: @estudiante.p3, p4: @estudiante.p4 } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { p1: @estudiante.p1, p2: @estudiante.p2, p3: @estudiante.p3, p4: @estudiante.p4 } }
