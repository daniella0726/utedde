...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { p1: @director.p1, p2a: @director.p2a, p2b: @director.p2b, p3: @director.p3 } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { p1: @director.p1, p2a: @director.p2a, p2b: @director.p2b, p3: @director.p3 } }
